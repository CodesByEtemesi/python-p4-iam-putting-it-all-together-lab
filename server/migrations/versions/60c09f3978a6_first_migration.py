...
Revision ID: 60c09f3978a6
Revises: 
Create Date: 2024-04-15 01:04:23.647047
...
def upgrade():
    ...
    sa.CheckConstraint('CHAR_LENGTH(instructions) >= 50', name='instructions_length'),
